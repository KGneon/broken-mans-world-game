...
<tileset version="1.10" tiledversion="1.11.2" name="tileset" tilewidth="16" tileheight="16" tilecount="192" columns="12">
 <image source="../Assets/QuillyRGGameAssetsPack/map/tileset.png" width="192" height="256"/>
 <tile id="1">
  <objectgroup draworder="index" id="2">
   <object id="1" x="0" y="5.15923" width="16" height="8.96469"/>
  </objectgroup>
 </tile>
 <tile id="2">
  <objectgroup draworder="index" id="2">
   <object id="13" x="-0.767488" y="5.75616">
    <polygon points="0,0 5.75616,4.47702 9.42305,10.7448 4.56229,10.8728 -0.255829,6.60893"/>
   </object>
  </objectgroup>
 </tile>
 <tile id="8">
 ...
 <wangsets>
  <wangset name="Unnamed Set" type="corner" tile="-1">
   ...
   <wangtile tileid="75" wangid="0,3,0,4,0,3,0,3"/>
   <wangtile tileid="76" wangid="0,3,0,4,0,4,0,3"/>
   <wangtile tileid="77" wangid="0,3,0,3,0,4,0,3"/>
   <wangtile tileid="78" wangid="0,4,0,3,0,4,0,4"/>
   <wangtile tileid="79" wangid="0,4,0,4,0,3,0,4"/>
   <wangtile tileid="85" wangid="0,4,0,4,0,4,0,4"/>
   <wangtile tileid="87" wangid="0,4,0,4,0,3,0,3"/>
   <wangtile tileid="88" wangid="0,4,0,4,0,4,0,4"/>
   <wangtile tileid="89" wangid="0,3,0,3,0,4,0,4"/>
   <wangtile tileid="90" wangid="0,3,0,4,0,4,0,4"/>
   <wangtile tileid="91" wangid="0,4,0,4,0,4,0,3"/>
   <wangtile tileid="99" wangid="0,4,0,3,0,3,0,3"/>
   ...
   <wangtile tileid="180" wangid="0,3,0,3,0,3,0,3"/>
